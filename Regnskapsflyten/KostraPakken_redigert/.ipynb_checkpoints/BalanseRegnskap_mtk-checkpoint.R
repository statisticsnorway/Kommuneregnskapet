...
CharacterReCodeRegnskapsomfang = function(x){
  x$regnskapsomfang = CharacterReCode(x$regnskapsomfang, c("A","B","C"), c("konsern", "kasse", "konsolidert"))
  x
}
...
BalanseRegnskapEnPeriode = function(data,kapittelhierarki,
  ...
  omfangAll  =  c("B","sbedr")    # A skal ikke med her.
  ...
  omfangAll = c("A",omfangAll, "C") # Brukes nedenfor
